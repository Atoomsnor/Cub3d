...
static void	move_left(t_game *game, double speed, float mod)
{
	t_vector	*pos;
	t_vector	dir;
	double		next_x;
...
static void	move_right(t_game *game, double speed, float mod)
{
	t_vector	*pos;
	t_vector	dir;
	double		next_x;
...
void	test_keyhook(void *param)
{
	...
	if (mlx_is_key_down(game->mlx, MLX_KEY_A))
		move_left(game, speed, mod);
	if (mlx_is_key_down(game->mlx, MLX_KEY_D))
		move_right(game, speed, mod);
